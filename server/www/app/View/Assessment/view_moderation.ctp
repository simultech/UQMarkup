...
ul#audio_annotations li a {
	color:orange;
}
#annotationframe ul li a span.badge {
	background:orange;
}
a.audioannotation_icon em {
	background:orange;
}
#annotationframe h3 {
	background:orange;
...
<ul class="nav nav-tabs">
    ...
    <li><a href="#">Marker 2</a></li>
    <li><a href="#">Marker 3</a></li>
</ul>
<?php
}
?>
...
<h1 id='moderation'>Marker Moderation</h1>
<div id='readerpage'>
	<div id='annotationframe'>
		<h3>Moderation Audio Annotations</h3>
		<div id='audioorder'>
...
<script type="text/javascript">
	...
	var annotations = <?php echo json_encode($annotations['audio']); ?>;
  	...
  	var baseaudiourl = '<?php echo $baseURL ?>/assessment/moderation_audio/<?php echo $submission['Submission']['id']; ?>/';
    var url = '<?php echo $baseURL ?>/assessment/moderation_markedPDF/<?php echo $submission['Submission']['id']; ?>';
    loadPDF(url);
    ...
    $(document).ready(function(){
		...
		$("#jquery_jplayer_1").bind($.jPlayer.event.ended, function(event) { 
			...
			$("#jquery_jplayer_1").jPlayer("setMedia", {
				mp3: baseaudiourl+annotations[playingannotation].filename
			});
    ...
    function play_annotation(annotation_id,shouldscroll) {
    	...
    	if(playingannotation != annotation_id) {
	    	...
	    	$("#jquery_jplayer_1").jPlayer("setMedia", {
				mp3: baseaudiourl+annotations[annotation_id].filename
			});
			$('#jp_container_1 p.name').html(annotations[playingannotation].title);
